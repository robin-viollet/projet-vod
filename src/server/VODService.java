...
public class VODService extends UnicastRemoteObject implements IVODService {
    ...
    private List<MovieDesc> catalog = List.of(
            ...
            new MovieDescPlus("The Batman", "t-heb-atman0", "When a sadistic serial killer begins murdering key political figures in Gotham, Batman is forced to investigate the city's hidden corruption and question his family's involvement.", new byte[]{0x0}),
            ...
            new MovieDescPlus("Shutter Island", "0-688-16317-3", "In 1954, a U.S. Marshal investigates the disappearance of a murderer who escaped from a hospital for the criminally insane.", new byte[]{0x0}));
